...
exports.methods = schemer = {
    ...
    scheme: {
        ...
        "generate": function (mode, colors, color) {
            var clr, color, colorCount, colorIndex, colorWeight, colors, counts, group, groupIndex, h, hSeed, hsl, l,
                lMaxSeed, lMinSeed, lSeed, maxRatio, maxRatioIndex, ratio, ratioIndex, ratios, s, sMaxSeed, sMinSeed,
                sSeed, scheme, seed, seedStep, _i, _j, _k, _l, _len, _len1, _len2, _len3, _m, _ref;
            colors = colors || [
                {h: 0, s: 0.5, l: 0.3},
                {h: .1, s: 0.5, l: 0.3},
                {h: .2, s: 0.5, l: 0.3},
